...
@section('title', 'Ladies Circle Nepal | Previous Members')
...
<section class="breadcrumbs">
    <div class="position-relative z-2 text-center">
        <h2 class="text-white breadcrumb-title">Previous Members</h2>
            ...
            <div class="col-lg-3 mb-4 col-md-6 col-sm-6">
                <div class="team-card mb-3">
                    <div class="team-img mx-auto">
                        <img src="{{ asset('uploads/previous-Members/'.$member->image) }}" class="w-100 p-2" alt="">
                    </div>
                </div>
                <div class="team-details">
                    <h4 class="text-center fs-5">{{$member->name}}</h4>
                    <h6 class="designation text-center">{{$member->designation}} ({{$member->tenure}})</h6>
                </div>
            </div> 
        @endif
        @endforeach
